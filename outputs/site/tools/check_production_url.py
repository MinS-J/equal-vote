...
REQUIRED_HOME_MARKERS = [
    ...
    "쉽게 말해, 실제 선거 데이터의 지역별 쏠림 특성을 시뮬레이션 프로그램에 넣고 같은 조건의 가상 선거를 20만 번 다시 치러 본 것이다.",
    "쉽게 말해, 같은 조건의 가상 선거를 20만 번 다시 치렀다",
    "쉽게 말해, 이미 관측된 지역 구조를 받아들였을 때 비슷한 일이 얼마나 다시 생기는지 보는 검증이다.",
