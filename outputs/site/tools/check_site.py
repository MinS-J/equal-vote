...
def check_site_data() -> None:
    ...
    html_required = [
        ...
        '<th>좁은 기준</th>',
        "A2</b>: 경계 인접 쌍(pair)에서 동일득표쌍이 1개 이상 발견된다.",
        "분할동 또는 실제 경계 인접 사례와 광역권 8쌍 이상",
        '<tbody id="joint-probability-body"></tbody>',
        "P(B|A)",
        "지역 인구 구조 변동",
        "지리적 인접의 한계",
        "분할동과 경계 인접은 서로 다른 좁은 비교 기준이다",
        "경계 인접 쌍(pair)",
        "진짜 옆동이면 어떤가",
        "bnd_dong",
    ...
    forbidden = [
        ...
        "1.58 / 백만 pair",
        "실제 경계 검산",
        "분할동 기준을 실제 지리 인접 기준으로 다시 좁혀 봤다",
        "보완 검산으로",
    ]
